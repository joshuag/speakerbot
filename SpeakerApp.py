...
@app.route('/')
def home():
    o_sounds = sb.load_sounds()

    return render_template("home.html", sounds=o_sounds, image=get_image(), random_title=parse_and_fill_mad_lib("The !adjective !noun !adverb !verb the !noun."))
